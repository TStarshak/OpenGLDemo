...
void Shader::compileShader(const char* vertexCode, const char* fragmentCode)
{
	...
	for (size_t i = 0; i < constants::MAX_POINT_LIGHTS; i++)
	{
		char locBuff[100] = { '\0' };
	...
	for (size_t i = 0; i < constants::MAX_SPOT_LIGHTS; i++)
	{
		char locBuff[100] = { '\0' };
...
{
	if (lightCount > constants::MAX_POINT_LIGHTS) lightCount = constants::MAX_POINT_LIGHTS;
...
{
	if (lightCount > constants::MAX_SPOT_LIGHTS) lightCount = constants::MAX_SPOT_LIGHTS;
